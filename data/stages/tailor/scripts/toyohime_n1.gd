...
func _ready() -> void:
	...
	toyohime_tween.tween_property(toyohime, "global_position", Vector2(250, 300), 2.0).set_trans(Tween.TRANS_QUAD)
	toyohime_tween.tween_callback(shoot_spiral.bind(toyohime))
	toyohime_tween.tween_interval(2.0)
	toyohime_tween.tween_property(toyohime, "global_position", Vector2(700, 300), 2.0).set_trans(Tween.TRANS_QUAD)
	toyohime_tween.tween_callback(shoot_spiral.bind(toyohime))
	toyohime_tween.tween_interval(2.0)
